<?php 
  ...
  if(isset($_POST['postwork'])){
    ...
    $sql = "INSERT INTO job_posts (job_post_position_id,job_post_skill_id,job_post_enterprise_id,job_post_employment_type_id,job_post_open_rate,job_post_income,job_post_details)
    VALUES('$job_post_position_id','$skills','$id','$job_post_employment_type_id','$job_post_open_rate','$job_post_income','$job_post_details')";
    ...
    <div class="container">
      <div class="p-4 w-100 rounded-30 bg-white justify-content-center mt-5">
          <div class="row">
            <div class="col">
              <div class="work">
                <label class="form-label fs-1" >รับสมัครงาน</label>
              </div>
            </div>
          </div>
          ...
          <form action="" method="post">
            <div class="row mt-2">
              ...
              <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                <button type="submit" class="btn btn-primary me-md-2 rounded-pill mt-4" name="postwork">โพสต์งาน</button>
                <a class="btn btn-warning me-md-2 rounded-pill mt-4" onclick="window.history.back()">ยกเลิกโพสต์งาน</a>
              </div> 
            </div>
          </form>
      </div>
