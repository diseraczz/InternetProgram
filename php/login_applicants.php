...
<html class="no-js" lang="zxx">
  ...
  <body>
    ...
    <form action="login_applicants.php" method="post">
      <div class="container p-4 bg-white mt-100 rounded-30" style="width: 600px;">
        ...
        <div class="container ">
          <label for="applicant_email" class="fs-4"><b>E-mail</b></label>
          <input class="rounded-25" type="text" placeholder="Enter Email" name="applicant_email" required autofocus>

          <label for="applicant_password" class="fs-4"><b>Password</b></label>
          <input class="rounded-25" type="password" placeholder="Enter Password" name="applicant_password" required>
          ...
          <div class="text-end d-flex mt-4" style="font-size: 1.rem;">
            ...
            <a href="register_applicants.php" class=" px-3" style="color: #bd0058">ลงทะเบียน</a>
          </div>
        </div>
    ...
    <?php
      if(isset($_POST['submit'])){
        ...
        $sql = "SELECT * FROM applicants WHERE applicant_email = '$applicant_email' AND applicant_password = '$passwordenc'";
        $query = mysqli_query($conn,$sql);
        $row = mysqli_fetch_array($query);

        if(is_array($row)){
          $_SESSION["applicant_email"] = $row['applicant_email'];
          $_SESSION["applicant_password"] = $row['applicant_password'];
          $_SESSION["applicant_firstname"] = $row['applicant_firstname'];
          $_SESSION["applicant_profile_pic"] = $row['applicant_profile_pic'];
          ...
          echo "window.location = 'login_applicants.php'; ";
          echo "</script>";
        }
      }
