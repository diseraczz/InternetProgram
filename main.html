            ...
            <form>
              ...
              <div class="row" ">
                  <div class="col">
                      ...
                      <select class="form-select" aria-label="Default select example" style="font-size: 1.1rem;">
                  ...
                  <div class="col">
                      ...
                      <select class="form-select" aria-label="Default select example" style="font-size: 1.1rem;">
                        <option selected>ประเภทการจ้าง</option>
                        <option value="1">งานประจำ</option>
                        <option value="2">งานพาร์ทไทม์</option>
                        <option value="3">งานสัญญาจ้าง</option>
                        <option value="4">งานอิสระ</option>
                        <option value="5">ฝึกงาน</option>
                      </select>
                  </div>
              </div>
            </form>   
    ...
    <div class="container" style="width: 1080px;">
        <div class="align-items-center bg-screen p-4 rounded-10 mt-5 ">
            ...
            <div class="work-content gap-4">
                <div class="col-work p-3" data-bs-toggle="modal" data-bs-target="#exampleModal">
                    <h6>insert work</h6>
                </div>
                <div class="col-work p-3" data-bs-toggle="modal" data-bs-target="#exampleModalxxxxxxxx">
                  <div class="row  p-4 justify-content-center ">
                      <a class="btn btn-primary" href="DashboardApplication.html" role="button">หน้าบริษัท</a>
                  </div>
                  <div class="row  p-4 justify-content-center ">
                    <a class="btn btn-primary" href="admin_page.html" role="button">หน้าแอดมิน</a>
                  </div>
                    <h6>หน้าบริษัท</h6>
                </div>
                <div class="col-work p-3" data-bs-toggle="modal" data-bs-target="#exampleModal">
                  <div class="row  p-4 justify-content-center ">
                    <a class="btn btn-primary" href="register.html" role="button">หน้าลงทะเบียน</a>
                  </div>
                  <div class="row  p-4 justify-content-center ">
                    <a class="btn btn-primary" href="login.html" role="button">หน้าล็อกอิน</a>
                  </div>
                    <h6>insert work</h6>
                </div>
                <div class="col-work p-3" data-bs-toggle="modal" data-bs-target="#exampleModal">
            ...
            <div class="modal-dialog modal-dialog-centered  ">
                <div class="modal-content ">
                    ...
                    <div class="modal-body">
                        <h4>รายละเอียดงาน และ หน้าที่รับผิดชอบ
                        </h4>
                    </div>
